  ...
  return (
    <>
      <div className="flex flex-wrap gap-6">
        {/* Left Column */}
        <div className="flex-grow md:flex-1 w-full min-w-[280px]">
          {/* Box 1 */}
        ...
        <div className="flex-1 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              ...
              <div
                key={index}
                className="custom-shadow flex items-center justify-between gap-3 bg-white px-4 py-6 rounded-md w-full"
              >
                <div>
